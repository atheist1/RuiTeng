...
<body>
 ...
 <script>
  alert( '${msg}' );
   location = "Picture_showPictureByAlbum.action?jumpPage="+${curpage};
 </script>
 </c:if>
 <div class="wrap">
  ...
  <div class="operate">
   <form action="Picture_showPictureByAlbum.action?jumpPage=1" method="post">
    <select class="inline-select" name="album">
     ...
     <c:choose>
     <c:when test="${al.albumid eq picturelist[0].albumid}">
  ...
  <div style="overflow:hidden;">
		...
		<div class="turnPage center fr">
			<a href="Picture_showPictureByAlbum.action?album=${picturelist[0].albumid}&jumpPage=1">首页</a>&nbsp;&nbsp;&nbsp;
			<a
			href="Picture_showPictureByAlbum.action?album=${picturelist[0].albumid}&jumpPage=${page.curPage - 1 }">前一页</a>&nbsp;&nbsp;&nbsp;
			<a
			href="Picture_showPictureByAlbum.action?album=${picturelist[0].albumid}&jumpPage=${page.curPage + 1}">后一页</a>&nbsp;&nbsp;&nbsp;
			<a
			href="Picture_showPictureByAlbum.action?album=${picturelist[0].albumid}&jumpPage=${page.maxPage }">尾页</a>&nbsp;&nbsp;&nbsp;
	    </div>
	  </div>
	<br><br><br><br><br>
 </div>
