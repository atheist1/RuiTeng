     ...
     <header id="header" class="">
        <div class="container">
            <div id="head_top" class="clearfix">
                <a href="index.jsp" class="logo clearfix"><img src="../image/mmexport1501831426456.png" alt=""></a>
                <a href="index.jsp" class="logo1 clearfix"><img src="../image/mmexport1501831427716.png" alt=""></a>
            </div>
        </div>
                        ...
                        <div id="imgs" class="imgs">
                            ...
                            <c:forEach items="${pictureAlbumList }" var="pi">
                                <li>
                                    ...
                                    <a href="#" class="imgTIt">${pi.picturedesc }</a>
                                </li>
                            </c:forEach>
                            </ul>
                        </div>
